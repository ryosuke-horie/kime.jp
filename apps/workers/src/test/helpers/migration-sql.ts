/**
 * テスト環境用のマイグレーションSQL定義
 * 本番用のマイグレーションファイルと同期を保つ必要があります
 */
...
// マイグレーションファイルの内容をコードとして定義
export const migrations: Migration[] = [
	{
		id: "0000_dapper_tinkerer",
		sql: `
...
`,
	...
	{
		id: "0001_exotic_captain_universe",
		sql: `ALTER TABLE \`gyms\` ADD \`password_hash\` text;`,
	},
];