...
export const migrations = [
	"-- Migration: 0000_dapper_tinkerer.sql",
...
FOREIGN KEY ("gym_id") REFERENCES "gyms"("gym_id") ON UPDATE no action ON DELETE no action
	...
	"-- Migration: 0001_exotic_captain_universe.sql",
	`ALTER TABLE "gyms" ADD "password_hash" text;`,
	"-- Migration: 0002_round_carmella_unuscione.sql",
	`ALTER TABLE "gyms" ADD "phone" text;`,
	`ALTER TABLE "gyms" ADD "website" text;`,
	`ALTER TABLE "gyms" ADD "address" text;`,
	`ALTER TABLE "gyms" ADD "description" text;`,
	"-- Migration: 0003_parched_sway.sql",
...
FOREIGN KEY ("gym_id") REFERENCES "gyms"("gym_id") ON UPDATE no action ON DELETE no action
	...
	`INSERT INTO "__new_staff"("staff_id", "gym_id", "name", "email", "role", "password_hash", "active", "last_login_at", "created_at") SELECT "staff_id", "gym_id", "name", "email", "role", "password_hash", "active", "last_login_at", "created_at" FROM "staff";`,
	`DROP TABLE "staff";`,
